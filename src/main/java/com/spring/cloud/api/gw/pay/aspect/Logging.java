package com.spring.cloud.api.gw.pay.aspect;
...
public class Logging {
     ...
     */
    @Pointcut("execution(* com.spring.cloud.api.gw.pay.controller..*Controller*.*(..)) || execution(* com.spring.cloud.api.gw.pay.service..*Service*.*(..))")
    private void cut() {
    }
